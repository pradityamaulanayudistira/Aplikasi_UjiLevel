    ...
    <div class="row">
        <div class="col-8 card p-3 bg-white">
            ...
            <div class="mt-5 row card-group">
                ...
                <div class="col-2 mb-4 item-cashier" data-id="{{$food['id_makanan']}}" data-name="{{$food['nama_makanan']}}" data-price="{{$food['harga_makanan']}}" data-image="{{$food['gambar_makanan']}}">
                    <div style="border: none;" class="card text-center">
                        <img style="border-radius: 15px !important; width: 90px;" class="rounded mx-auto d-block" src="image/{{ $food['gambar_makanan'] }}" class="card-img-top" alt="...">
                        <div class="card-body p-2">
                            <h5 class="h6 card-title mb-1 font-weight-bold text-dark">{{ $food['nama_makanan'] }}</h5>
                            <p style="font-size: 12px;" class="card-text text-dark">Rp {{ $food['harga_makanan'] }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
